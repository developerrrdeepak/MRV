...
export default function FarmerAuth() {
  ...
  const { signInFarmer, registerFarmer, isLoading, isAuthenticated } =
    useFarmerAuth();
  ...
  const handleRegistration = async (e: React.FormEvent) => {
    ...
    const farmerData = {
      ...
      location: {
        ...
        coordinates:
          registrationForm.latitude && registrationForm.longitude
            ? {
      ...
      farmDetails: {
        ...
        croppingPattern: registrationForm.croppingPattern
          .split(",")
          .map((crop) => crop.trim()),
      ...
      profile: {
        ...
        experience: registrationForm.experience
          ? parseInt(registrationForm.experience)
          : undefined,
      },
    ...
    if (result.success) {
      alert(
        `Registration successful! Your Farmer ID is: ${result.farmer?.farmerId}`,
      );
      navigate("/farmer-dashboard");
    } else {
            ...
            <TabsContent value="signin" className="space-y-6">
              <div className="text-center space-y-2">
                ...
                <p className="text-gray-600">
                  Sign in with your Farmer ID or phone number
                </p>
              </div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setSignInForm((prev) => ({
                          ...prev,
                          farmerId: e.target.value.toUpperCase(),
                        }))
                      }
                      className="pl-10"
                      required
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setRegistrationForm((prev) => ({
                            ...prev,
                            croppingPattern: e.target.value,
                          }))
                        }
                      />
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        value={registrationForm.soilType}
                        onValueChange={(value) =>
                          setRegistrationForm((prev) => ({
                            ...prev,
                            soilType: value,
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        value={registrationForm.irrigationType}
                        onValueChange={(value) =>
                          setRegistrationForm((prev) => ({
                            ...prev,
