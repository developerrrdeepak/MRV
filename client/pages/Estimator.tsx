      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="mb-2">
          ...
          <p className="text-gray-600 text-lg">
            Use our external carbon stock estimation model. If the embedded view
            is blocked by the site, open it in a new tab.
          </p>
        </div>
        ...
        <Card>
          <CardHeader className="flex items-center justify-between space-y-0">
            <div>
              ...
              <CardDescription>
                Interactive tool from carbonstockestimation.mgx.world
              </CardDescription>
            </div>
